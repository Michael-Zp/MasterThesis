...
bool Entry::Init()
{
	...
	mRenderItems.push_back(new HairSimulatedWithTractixSplines(md3dDevice, md3dImmediateContext, new TractrixSimulation(md3dDevice, md3dImmediateContext, { true, false, false, true }, (XMFLOAT4)Colors::Red, TractrixSimulation::Configuration::Z4Points)));
