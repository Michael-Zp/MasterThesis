...
OneDFlexObjSimulation::OneDFlexObjSimulation(std::vector<std::vector<XMFLOAT3>*> positions, ID3D11Device *device, ID3D11DeviceContext *context)
{
	...
	mComputeShader = new ComputeShader(L"./Shader/cOneDFlexObjSimulation.hlsl", "Simulation", true);
	//mComputeShader = new ComputeShader(L"./Shader/cOneDFlexObjDifferentialSimulation.hlsl", "Simulation", true);
	mComputeShader->prepare(device);
}


OneDFlexObjSimulation::~OneDFlexObjSimulation()
{

}


void OneDFlexObjSimulation::Simulate(const float deltaTime, ID3D11DeviceContext *context)
{
