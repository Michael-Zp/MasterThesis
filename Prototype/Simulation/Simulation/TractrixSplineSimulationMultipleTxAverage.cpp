...
TractrixSplineSimulationMultipleTxAverage::TractrixSplineSimulationMultipleTxAverage(ID3D11Device *device, ID3D11DeviceContext *context, PropertiesConstBuf props, XMFLOAT4 strandColor, Configuration config)
{
	...
	switch (config)
	{
	case TractrixSplineSimulationMultipleTxAverage::Configuration::Z4Points:
	case TractrixSplineSimulationMultipleTxAverage::Configuration::Z4PointsStretch:
		myDirections = {
			XMFLOAT3(0, -1, 0),
			XMFLOAT3(1, 0, 0),
			XMFLOAT3(0, -1, 0)
		...
		break;
	case TractrixSplineSimulationMultipleTxAverage::Configuration::ZReverse4Points:
		myDirections = {
			XMFLOAT3(0, -1, 0),
			XMFLOAT3(-1, 0, 0),
			XMFLOAT3(0, -1, 0)
		...
		break;
	case TractrixSplineSimulationMultipleTxAverage::Configuration::I4Points:
		myDirections = {
			XMFLOAT3(0, -1, 0),
			XMFLOAT3(0, -1, 0),
			XMFLOAT3(0, -1, 0)
	...
	case TractrixSplineSimulationMultipleTxAverage::Configuration::Z5Points:
	case TractrixSplineSimulationMultipleTxAverage::Configuration::Z5PointsStretch:
		myDirections = {
			XMFLOAT3(0, -1, 0),
			XMFLOAT3(1, 0, 0),
			XMFLOAT3(0, -1, 0),
		...
		break;
	case TractrixSplineSimulationMultipleTxAverage::Configuration::ZReverse5Points:
		myDirections = {
			XMFLOAT3(0, -1, 0),
			XMFLOAT3(1, 0, 0),
			XMFLOAT3(0, -1, 0),
	...
	std::vector<TractrixSplineSimulationMultipleTxAverage::Strand> strands;
	...
	mComputeShader = new ComputeShader(L"./Shader/cTractrixSplineSimulationMultipleTxAverage.hlsl", "Simulation", true);
	mComputeShader->prepare(device);
}


TractrixSplineSimulationMultipleTxAverage::~TractrixSplineSimulationMultipleTxAverage()
{

}

void TractrixSplineSimulationMultipleTxAverage::Simulate(const float deltaTime, ID3D11DeviceContext *context)
{
