...
class TractrixSplineSimulationMultipleTxAverage : public ITractrixSimulation
{
private:
...
public:
	...
	TractrixSplineSimulationMultipleTxAverage(ID3D11Device *device, ID3D11DeviceContext *context, PropertiesConstBuf props, XMFLOAT4 strandColor, Configuration config);
	~TractrixSplineSimulationMultipleTxAverage();
