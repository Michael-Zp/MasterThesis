...
TractrixSplineSimulationMultipleSingleTxSteps::TractrixSplineSimulationMultipleSingleTxSteps(ID3D11Device *device, ID3D11DeviceContext *context, PropertiesConstBuf props, XMFLOAT4 strandColor, Configuration config)
{
	...
	switch (config)
	{
	case TractrixSplineSimulationMultipleSingleTxSteps::Configuration::Z4Points:
	case TractrixSplineSimulationMultipleSingleTxSteps::Configuration::Z4PointsStretch:
		myDirections = {
			XMFLOAT3(0, -1, 0),
			XMFLOAT3(1, 0, 0),
			XMFLOAT3(0, -1, 0)
		...
		break;
	case TractrixSplineSimulationMultipleSingleTxSteps::Configuration::ZReverse4Points:
		myDirections = {
			XMFLOAT3(0, -1, 0),
			XMFLOAT3(-1, 0, 0),
			XMFLOAT3(0, -1, 0)
		...
		break;
	case TractrixSplineSimulationMultipleSingleTxSteps::Configuration::I4Points:
		myDirections = {
			XMFLOAT3(0, -1, 0),
			XMFLOAT3(0, -1, 0),
			XMFLOAT3(0, -1, 0)
	...
	case TractrixSplineSimulationMultipleSingleTxSteps::Configuration::Z5Points:
	case TractrixSplineSimulationMultipleSingleTxSteps::Configuration::Z5PointsStretch:
		myDirections = {
			XMFLOAT3(0, -1, 0),
			XMFLOAT3(1, 0, 0),
			XMFLOAT3(0, -1, 0),
		...
		break;
	case TractrixSplineSimulationMultipleSingleTxSteps::Configuration::ZReverse5Points:
		myDirections = {
			XMFLOAT3(0, -1, 0),
			XMFLOAT3(1, 0, 0),
			XMFLOAT3(0, -1, 0),
	...
	std::vector<TractrixSplineSimulationMultipleSingleTxSteps::Strand> strands;
	...
	mComputeShader = new ComputeShader(L"./Shader/cTractrixSplineSimulationMultipleSingleTxSteps.hlsl", "Simulation", true);
	mComputeShader->prepare(device);
}


TractrixSplineSimulationMultipleSingleTxSteps::~TractrixSplineSimulationMultipleSingleTxSteps()
{

}

void TractrixSplineSimulationMultipleSingleTxSteps::Simulate(const float deltaTime, ID3D11DeviceContext *context)
{
