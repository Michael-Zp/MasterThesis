...
class TractrixSplineSimulationGlobalForces : public ITractrixSimulation
{
private:
...
public:
	...
	TractrixSplineSimulationGlobalForces(ID3D11Device *device, ID3D11DeviceContext *context, PropertiesConstBuf props, XMFLOAT4 strandColor, Configuration config);
	~TractrixSplineSimulationGlobalForces();
