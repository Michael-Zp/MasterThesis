...
class TractrixSplineSimulationMultipleSingleTxSteps : public ITractrixSimulation
{
private:
...
public:
	...
	TractrixSplineSimulationMultipleSingleTxSteps(ID3D11Device *device, ID3D11DeviceContext *context, PropertiesConstBuf props, XMFLOAT4 strandColor, Configuration config);
	~TractrixSplineSimulationMultipleSingleTxSteps();
